    ...
    return (
      <div className="flex bg-white">
        <Card className="h-[calc(100vh-.01rem)] w-full max-w-[16rem] p-4 bg-[#D9D0C1] rounded-none lg:flex flex-col hidden">
          ...
          {/* Ajustar espaciado de Settings y Log Out */}
          <ListItem className="group hover:bg-[#40251B] hover:text-[#D9D0C1] focus:bg-[#40251B] focus:text-[#D9D0C1] text-[#40251B] font-bold active:bg-[#40251B] active:text-[#D9D0C1] p-2 mb-4">
            <ListItemPrefix>
